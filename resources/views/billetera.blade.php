            ...
            <div class="header-body" style="height: 38rem;">
                ...
                <div class="
                                ...
                                <div class="col-md-4 mb-5">
                                    <button type="button" class="btn btn-block " style="margin-bottom: 9rem; background: #f5f8ff;
                                    color: #9DC2FF;" data-toggle="modal"
                                        data-target="#modal-default">Solicitar Retiro</button>
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="py-3 text-center">
                                                        ...
                                                        <p>Para retirar dinero, necesitas 30 puntos acumulados!</p>
                                                    </div>

                                                </div>

                                                <div class="modal-footer">
                                                    <button type="button" class="btn text-white" style="background:#274b8e; ">Aceptar</button>
                                                    <button type="button" class="btn btn-link ml-auto" style="color:#274b8e;"
