                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="col-auto pr-0 pl-0">
                                            ...
                                            <p class="text-center mb-0"><span
                                                    class="position-absolute p-1 align-middle @if ($notificacion->estado == 'no leido')bg-success @endif rounded-circle" style="margin-top: 40%;"></span><i class="@if ($notificacion->tipo == 'educacion')ni ni-book-bookmark @elseif ($notificacion->tipo == 'desafio') ni ni-lock-circle-open @elseif($notificacion->tipo == 'alianza') far fa-handshake @elseif($notificacion->tipo == 'ranking') ni ni-trophy @else ni ni-notification-70 @endif p-3"></i>
                                            </p>
                                        </div>
