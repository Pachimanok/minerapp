...
<div class="header pb-3">
  <div class="container">
    ...
    <div class="card mt-2" style="border: none;">
      <form class="mb-5"action="/pedidofranjuegos/{{$pedido->id}}" method="POST">
        @method('PUT')
        @csrf
      <div class="card-body">
        ...
        @foreach ($detalle as $detalle)
            <div class="col-auto" style="display: flex;">
              <img alt="Image placeholder" src="{{ asset('img/franjuegos/' . $detalle->foto) }}" class="avatar rounded-circle">
