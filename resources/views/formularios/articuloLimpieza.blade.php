        ...
        <div class="card bg-white" style="border-none">
          <div class="card-body text-center">
            @foreach ($limpieza as $limpieza)
                <h1 class="text-primary text-center">{{$limpieza->titulo}}</h1>
                    <div class="pl-lg-4">
                        <div class="col-sm-3 mx-auto">
                            <div>
                                <img src="../img/limpieza/{{ $limpieza->foto}}" alt="error en foto">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-5 mx-auto">
                            <h4 class="text-center">{{ $limpieza->description}}</h4>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-sm-5 mx-auto text-light text-center" style="text-align:center;">
                            <h3 class="text-center" style="color: gray;">Rubro: {{ $limpieza->rubro}}</h3>
                        </div>
                    </div>
                    <div class="row">
