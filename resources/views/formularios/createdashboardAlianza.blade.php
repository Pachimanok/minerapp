...
<div class="bg-info">
    <div class="container pb-5">
        ...
        <div class="row">
            <form action="/dashboard/alianza" method="POST" enctype="multipart/form-data"
                class="row g-3">
                @csrf
                {{ method_field('PATCH') }}
                ...
                <input type="number" name="cuit" class="form-control" id="validationDefault03"
                    value="" required>
                ...
                <input type="number" name="celular" class="form-control" id="validationDefault03"
                    value="" required>
                ...
                <input type="text" name="linkcat" class="form-control" id="validationDefault03"
                    value="" required>

                <label for="validationDefault03" class="form-label">Link promo: </label>
                <input type="text" name="linkpromo" class="form-control" id="validationDefault03"
                    value="" required>
                ...
                <input type="text" name="rubro" class="form-control" id="validationDefault03"
                    value="" required>
                ...
                <textarea name="terminos" class="form-control"
                    id="validationTextarea"></textarea>
