      ...
      <div class="container-fluid">
        <div class="card bg-primary" style="border-none">
          <div class="card-body text-center">
                ...
                <form class="mb-5" action="/educacion/{{ $educacion->id }}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-2 mx-auto" >
                                <select name="estado[]"  class="form-control" id="">
                                    <option value="{{ $educacion->estado }}">-Cambiar estado: {{ $educacion->estado }}</option>
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto">
                                <input type="name" value="{{ $educacion->titulo }}"class="form-control mx-auto" name="titulo" placeholder="Responsabilidad, tu compromiso con la Sociedad">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto text-light text-center" style="text-align:center;">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto text-light">
                                <textarea name="descripcion" rows="5" class="form-control" placeholder="Pequeña descripción o Introduccion del tema que se tocará">{{ $educacion->descripcion }}</textarea>
                            </div>
                        </div>
                        <div class="row mt-2">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto">
                                <input type="text" class="form-control mx-auto" name="tema"  value="{{ $educacion->tema }}">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto text-light text-center">
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-5 mx-auto">
                                <input type="text" class="form-control mx-auto" name="link"  value="{{ $educacion->link }}"placeholder="https://classroom.google.com/u/0/c/Mjg4NjYwNzEwNjQ">
                            </div>
                        </div>
                        <br>
                        <div class="row">
