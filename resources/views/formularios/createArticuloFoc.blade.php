        ...
        <div class="container-fluid">
            <div class="card" style="border-none">
                <div class="card-body text-center">
                    ...
                    <br>
                    <form class="mb-5" action="/catfoc" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="pl-lg-4">
                        ...
                        <div class="row">
                            <div class="col-sm-5 mx-auto">
                                <input type="text" class="form-control mx-auto" name="titulo" placeholder="Costilla de Primera"
                                    required>
                            </div>
                        </div>
                        <div class="row mt-3">
