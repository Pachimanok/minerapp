                    ...
                    <div class="card shadow">
                      <div class="card-header bg-transparent border-0">
                        ...
                        <div class="col-sm-5  text-center mb-2">
                            <a href="/catbluesea/create" class="col-sm-5 btn btn-primary">Agregar Producto</a>
                            <a href="/bluesea" class="col-sm-5 btn btn-primary">Ver Catalogo</a>
                        </div>
                      </div>
                              ...
                              <th scope="row">
                                <div class="media align-items-center">
                                  <a href="#" class="avatar rounded-circle mr-3">
                                    <img alt="Image placeholder" src="../img/bluesea/{{ $articulo->foto}}">
                                  </a>
                              ...
                              <td class="text-right">
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="catbluesea/{{$articulo->id}}">Ver</a>
                                    <a class="dropdown-item" href="catbluesea/{{$articulo->id}}/edit">Editar</a>
                                    <form action="catbluesea/{{$articulo->id}}" method="POST">@csrf @method('DELETE')<button type="submit" class="dropdown-item">Eliminar</button></form>
                                  </div>
                                </div>
                              </td>
                            </tr>
