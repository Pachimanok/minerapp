                ...
                @foreach ( $alianzas as $alianza)
                    <tr>
                        ...
                        <td>
                            ...
                            @csrf
                            {{ method_field('DELETE') }}
                            <a href="/alianzas/{{ $alianza->id }}" class="btn btn-primary"><i class="far fa-eye"></i></a>
                            <a href="/alianzas/{{ $alianza->id }}/edit" class="btn btn-success"><i class="fas fa-pencil-alt"></i></a>
                            <button href="/alianzas/{{ $alianza->id }}" onclick="return confirm('¿Quieres eliminar esta alianza?')" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
