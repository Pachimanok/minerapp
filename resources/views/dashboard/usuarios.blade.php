                        ...
                        <tr>
                            ...
                            <td>
                                <form action="/dashboard/usuarios/{{ $user->id }}" method="POST">
                                    @csrf
                                    {{ method_field('DELETE') }}
                                    <a href="/dashboard/usuarios/{{ $user->id }}/edit" class="btn btn-success"><i
                                            class="fas fa-pencil-alt"></i></a>
                                    <button href="/dashboard/usuarios/{{ $user->id }}"
                                        onclick="return confirm('¿Quieres eliminar este usuario {{ $user->id }}?')"
