                ...
                @foreach ( $notificaciones as $notificacion)
                    <tr>
                        ...
                        <td>
                            ...
                            @csrf
                            {{ method_field('DELETE') }}
                            <a href="/dashboard/notificaciones/{{ $notificacion->id }}" class="btn btn-primary"><i class="far fa-eye"></i></a>
                            <button href="/dashboard/notificaciones/{{ $notificacion->id }}" onclick="return confirm('¿Quieres eliminar esta notificacion?')" class="btn btn-danger"><i class="fas fa-trash"></i></button>
                            </form>
                        </td>
                    </tr>
                @endforeach
