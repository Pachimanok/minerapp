...
class pedidoPlimplimController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $actualiza = pedidoplimplim::find($id);
        ...
        $billetera->descripcion = 'Pañales PlimPlim:'.$id;
        $billetera->alianza = 'Plim Plim Pañalín';
        ...
        $res = DB::table('pedidoplimplims')->join('minas','pedidoplimplims.minaid','=','minas.id')->where('pedidoplimplims.id', '=' ,$id)->get();
        $resumen = $res[0];

        return view('plimplim.resumen')->with('mineros', $minero)->with('user', $usuario)->with('resumen', $resumen);
    }
