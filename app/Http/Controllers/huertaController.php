...
class huertaController extends Controller
{
    ...
    public function index()
    {
        ...
        if($usuario->role == 'minero'){
            ...
            $minero = $min[0];
            return view('huerta.catalogo')->with('mineros', $minero)->with('user', $usuario)->with('rubros', $rubros)->with('articulos', $articulos);
            ...
            return view('huerta.catalogo')->with('alianza', $ali)->with('user', $usuario)->with('rubros', $rubros)->with('articulos', $articulos);
    ...
    public function store(Request $request)
    {
        ...
        return view('huerta.minaseleccionada')->with('mineros', $minero)->with('user', $usuario)->with('mina', $entrega);
    }
