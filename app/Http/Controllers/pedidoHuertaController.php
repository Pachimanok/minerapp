...
class pedidoHuertaController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
        ...
        $actualiza = pedidohuerta::find($id);
        ...
        $billetera->descripcion = 'Huerta OnLine:'.$id;
        $billetera->alianza = 'huertaonline';
        ...
        $res = DB::table('pedidohuertas')->join('minas','pedidohuertas.minaid','=','minas.id')->where('pedidohuertas.id', '=' ,$id)->get();
        $resumen = $res[0];

        return view('huerta.resumen')->with('mineros', $minero)->with('user', $usuario)->with('resumen', $resumen);
    }
