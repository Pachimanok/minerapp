...
class FocController extends Controller
{
    ...
    public function index()
    {
        ...
        if($usuario->role == 'minero'){
            ...
            $minero = $min[0];
            return view('foc.catalogo')->with('mineros', $minero)->with('user', $usuario)->with('rubros', $rubros)->with('articulos', $articulos);
            ...
            return view('foc.catalogo')->with('alianza', $ali)->with('user', $usuario)->with('rubros', $rubros)->with('articulos', $articulos);
    ...
    public function create()
    {
        ...
        return view('foc.minar')->with('mineros', $minero)->with('user', $usuario)->with('minas', $qmina);
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('foc.minaseleccionada')->with('mineros', $minero)->with('user', $usuario)->with('mina', $entrega);
    }
