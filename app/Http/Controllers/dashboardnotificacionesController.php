...
class dashboardnotificacionesController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('formularios.createdashboardNotificaciones')->with('usuarios', $usuarios);
    }
    ...
    {   
        ...
        return view('formularios.verdashboardNotificacion')->with('notificacion', $notificacion);
